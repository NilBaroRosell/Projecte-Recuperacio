...
public class Target : MonoBehaviour {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (GameObject.Find("Plane").GetComponent<PlayerController>().back || GameObject.Find("Plane").GetComponent<PlayerController>().left || GameObject.Find("Plane").GetComponent<PlayerController>().right)
            {
